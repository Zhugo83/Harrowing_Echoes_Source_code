...
class GhostTapOption extends Option
{
	...
	private override function updateDisplay():String
	{
		return FlxG.save.data.ghost ? "Having skill issue" : "Having skill";
	}
}

class NoBackgroundOption extends Option
{
	public function new(desc:String)
	{
		super();
	...
	private override function updateDisplay():String
	{
		return FlxG.save.data.Lesslag ? "No background" : "Showing Background";
	}
}

class NoCharaterOption extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.save.data.Character = !FlxG.save.data.Character;
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return FlxG.save.data.Character ? "No character" : "Showing Character";
	}
}
